export const piecework = {
  ...
  rules: {
    ...
    page: {
      ...
      headerDescription: 'Manage process-level piecework unit price baselines under a controlled tracking flow.',
      statusBadge: 'Audit Tracking Active',
      searchPlaceholder: 'Search process names or related product SKU...',
    ...
    dialog: {
      ...
      description: 'Set atomic process-level rates and route every change into the audit stream.',
      ...
      placeholders: {
        ...
        processName: 'e.g. Strip Forming / Punching',
        piecePrice: '0.00',
        unit: 'PCS / KG',
    ...
    toast: {
      validationRequired: 'Missing required inputs: product, process, or rate',
  ...
  validation: {
    ...
    pieceworkRateProcessNameRequired: 'Please enter a process name',
