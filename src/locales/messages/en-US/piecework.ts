  ...
  rules: {
    ...
    dialog: {
      ...
      fields: {
        ...
        processName: '{{levelName}} Name',
        processStep: 'Work Operation',
        routeStep: 'Route Step (Optional)',
        piecePrice: 'Piece Rate',
        unitPrice: 'Unit Price',
      ...
      placeholders: {
        ...
        processStep: 'Select a standard work operation',
        routeStep: 'Select a product route step',
        piecePrice: '0.00',
        unitPrice: '0.0000',
        unit: 'PCS / KG',
        effectiveFrom: 'Leave blank to activate immediately',
        effectiveTo: 'Leave blank for an open-ended rate',
