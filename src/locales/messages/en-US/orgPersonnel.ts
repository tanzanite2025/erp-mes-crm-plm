export const orgPersonnel = {
  ...
  list: {
    ...
    bulk: {
      ...
      deleteDialog: {
        ...
        desc: 'Are you sure you want to permanently delete selected personnel? This will also remove associated station mapping and is irreversible.',
  ...
  org: {
    ...
    personnelProfile: {
      ...
      desc: 'Management of personnel archives, station mappings, and onboarding lifecycles.',
    },
    types: {
    ...
    jobDialog: {
      ...
      desc: 'Define job name, process code, and station assignment.',
      nameLabel: 'Job Name',
      namePlaceholder: 'e.g. TIG Welder',
      codeLabel: 'Job Code',
      codePlaceholder: 'e.g. WELD-AR',
      stationLabel: 'Station',
      stationPlaceholder: 'e.g. A1-01',
    ...
    validation: {
      ...
      jobStationRequired: 'Station assignment is required',
  ...
  lineMgmt: {
    header: {
      ...
      subtitle: 'Digital production path definition, supports complex topology configuration of multiple segments and stations',
    },
    list: {
      searchPlaceholder: 'Search line code or name...',
      addButton: 'Add Line',
      emptyTitle: 'No Production Line Data',
      emptyDesc: 'Click "Add Line" to establish a digital production path and define the hierarchy of segments and stations.',
    ...
    card: {
      ...
      delete: 'Delete Line',
      hierarchy: 'Hierarchy',
      hierarchyStats: '{{segments}} segments / {{jobs}} job categories / {{stations}} stations',
      status: 'Status',
    ...
    topology: {
      ...
      segmentRemoveDesc: 'Removing the entire segment will clear all underlying processes and stations. High risk. Please enter the authorization code to continue',
      jobCategoryRenameTitle: 'Job Category Definition Change',
      jobCategoryRemoveTitle: 'Remove Job Category Resource',
      jobCategoryRenameDesc: 'Renaming the job category affects the hierarchy between segments, stations, and teams. Please verify the auth code',
      jobCategoryRemoveDesc: 'Removing the job category will also clear all child station definitions. Please enter the authorization code to continue',
      stationRenameAuth: 'Auth Rename',
      stationRemoveAuth: 'Remove Station',
      stationRenameTitle: 'Structure Change Auth',
      stationRemoveTitle: 'Remove Resource Auth',
      stationRenameDesc: 'Modifying station unique code. Please enter the authorization code to continue',
      stationRemoveDesc: 'Removing the station will invalidate associated scheduling data. Please enter the authorization code to continue',
  ...
  topologyTemplateMgmt: {
      ...
      card: {
        ...
        deleteSegmentDesc: 'Removing the segment template [{{name}}] will clear all its child job categories and stations.',
        deleteJobCategoryTitle: 'Confirm Removal of Standard Job Category?',
        deleteJobCategoryDesc: 'Deleting the job category [{{name}}] will also remove all child station definitions from this template.',
        deleteStationTitle: 'Remove Standard Station?',
        deleteStationDesc: 'Are you sure you want to remove this station definition from the template?',
        addJobCategory: 'Add Job Category',
        addStation: 'Add Station',
        ...
        defaultStation: 'Standard Station {{index}}',
      },
      dialog: {
