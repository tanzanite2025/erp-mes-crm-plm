export const orgPersonnel = {
  ...
  lineMgmt: {
    ...
    card: {
      ...
      delete: 'Delete Line',
      hierarchy: 'Hierarchy',
      hierarchyStats: '{{segments}} segments / {{jobs}} processes',
      status: 'Status',
    ...
    topology: {
      ...
      processRenameTitle: 'Process Definition Change',
      processRemoveTitle: 'Remove Process Resource',
      processRenameDesc: 'Redefining the process name will affect line path configuration, please verify auth code',
      processRemoveDesc: 'Removing the process will delete the corresponding flow node from this segment, please verify auth code',
  ...
  topologyTemplateMgmt: {
      ...
      card: {
        ...
        deleteSegmentDesc: 'Removing the segment template [{{name}}] will clear all its underlying processes.',
        deleteProcessTitle: 'Confirm Removal of Standard Process?',
        deleteProcessDesc: 'Deleting the process template [{{name}}] will remove its standard definition from this template.',
        addProcess: 'Add Process',
        addSegment: 'Define New Standard Segment',
        defaultSegment: 'Standard Segment {{index}}',
        defaultProcess: 'Standard Process {{index}}',
      },
      dialog: {
