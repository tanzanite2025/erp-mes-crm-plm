export const orgPersonnel = {
  ...
  leaveMgmt: {
    ...
    actionDialog: {
      ...
      description: 'Only self-submissions are supported. Leave duration is based on the backend authoritative preview.',
      unboundEmployee: 'The current account is not linked to an employee archive, so leave requests cannot be submitted.',
      leaveType: 'Leave Type',
