export const engineering = {
  ...
  cuttingPlan: {
    ...
    alerts: {
      ...
      failureTypes: {
        missing_required_fields: 'Missing fields {{count}}',
        invalid_lines: 'Invalid lines {{count}}',
        schema_mismatch: 'Schema mismatch {{count}}',
        unknown_invalid_payload: 'Unknown payload {{count}}',
      },
      failureGroups: {
        missing_required_fields: 'Missing required fields',
        invalid_lines: 'Invalid cut lines',
        schema_mismatch: 'Cutting plan schema mismatch',
        unknown_invalid_payload: 'Unknown invalid payload',
      },
  ...
  productMgmt: {
    ...
    sidebar: {
      ...
      ownerCustomerUnknown: 'Unknown customer',
      ownerNoBom: 'No BOM yet',
    },
    ...
    templateSummaryUnavailable: 'Template Summary Unresolved',
    skuIdLabel: 'SKU ID',
    ...
    activeBom: {
      ...
      lines: 'Lines',
      openBom: 'Open BOM',
      noBomYet: 'No BOM has been created for {{product}} yet',
      createFirstBom: 'Create First BOM',
      draftStatus: 'Draft {{version}}',
      draftHint: 'Latest BOM is still draft / under review',
      loadFailed: 'Failed to load active BOM',
    },
  ...
  bomArchive: {
    ...
    dialog: {
      ...
      locked: 'Current version is locked',
    },
    actions: {
      derive: 'Derive MBOM',
    },
    form: {
      ...
      measuredWeightPlaceholder: 'Enter weight…',
      measuredWeightUnit: 'Weight Unit',
      measuredWeightUnitPlaceholder: 'Pick a weight unit…',
      ownerType: 'Owner',
      ownerTypePlaceholder: 'Pick owner type…',
      ownerTypeInternal: 'Internal Production',
      ownerTypeCustomer: 'Customer Specific',
      ownerCustomer: 'Owner Customer',
      ownerCustomerPlaceholder: 'Pick a customer…',
    },
    recipe: {
    ...
    summary: {
      ...
      stageCoverage: 'Hierarchy Coverage',
      sectionDistribution: 'Hierarchy Distribution Overview',
    },
    toasts: {
  ...
  specForms: {
    ...
    stem: {
      ...
      subtitle: 'Geometric dimensions and fixed parameters',
      length: 'Length (L/mm)',
      angle: 'Angle (A/deg)',
