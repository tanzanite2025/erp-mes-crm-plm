export const purchase = {
  ...
  orders: {
    ...
    detailReceiptAutoRemarks:
      'Manual receipt confirmation from purchase order page',
    detailEvidenceTitle: 'Purchase Contract Evidence',
    receiptDialogDescription:
      'Review each receipt line, batch number, and target warehouse category before submitting.',
    ...
    validation: {
      ...
      lineInvalid:
        'Please complete the line details. Material is required and quantity must be greater than 0.',
    },
    status: {
      draft: 'Draft',
      sent: 'Sent',
  ...
  payables: {
    ...
    description:
      'Payables entry point for the purchase domain, reserved for payment progress, aging, and reconciliation views.',
    summaryTotal: 'Outstanding Payables',
    summaryOverdue: 'Overdue Amount',
    summaryPending: 'Pending Payments',
    tableTitle: 'Payables List',
    tableDescription:
      'Review payable ledgers, aging status, and open the detail dialog for payment registration and allocation.',
    orderDialog: {
  ...
  logistics: {
    ...
    offlineQueuedDesc:
      'Tracking No. {{trackingNo}} has been saved locally and will sync when the network recovers.',
    offlineDraftsTitle: 'Offline Inbound Drafts',
    offlineDraftsDesc:
      'These records are only stored on this device and have not been formally submitted yet.',
    ...
    offlineSyncSuccessDesc:
      '{{count}} draft(s) have been submitted successfully.',
    offlineSyncPending: 'Drafts still pending',
    offlineSyncPendingDesc:
      '{{count}} draft(s) are still stored locally. Please review and retry later.',
