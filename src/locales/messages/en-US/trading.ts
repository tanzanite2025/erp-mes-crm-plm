export const trading = {
  ...
  salesReturns: {
    ...
    queryShell: {
      ...
      editSuccess: 'Sales return updated successfully',
      deleteSuccess: 'Sales return deleted successfully',
      actualAmountEntrySuccess: 'Actual return amount saved successfully',
      ...
      editorPanelTitle: 'Return edit and supplement panel',
      clearSelection: 'Close right panel',
      closePanel: 'Close right panel',
      editAction: 'Edit return',
      deleteAction: 'Delete return',
      deleteConfirmAction: 'Confirm delete',
      deleteConfirmTitle: 'Confirm sales return deletion',
      deleteConfirmDescription:
        'You are about to delete the real sales-return document {{returnNo}}. After deletion, the right edit/supplement panel and linked amount records will leave the current page view together.',
      actualAmountEntryAction: 'Record return amount',
      customer: 'Customer',
      ...
      actualAmount: 'Actual return amount',
      actualAmountEmpty: 'Not recorded yet',
      actualAmountRecordedAt: 'Recorded at',
      actualAmountRecordedBy: 'Recorded by',
    },
    entryShell: {
    ...
    createSheet: {
      ...
      returnDate: 'Return date',
      trackingNo: 'Tracking number',
      trackingNoPlaceholder: 'Can be left empty and filled later',
      carrier: 'Carrier',
    ...
    editSheet: {
      ...
      description:
        'Adjust the current real sales-return document and its return lines based on source order {{orderNo}}.',
      summaryReturnNo: 'Return number',
      sourceLoading: 'Loading source order...',
      sourceLoadFailed: 'Failed to load source order. Please try again later.',
      submit: 'Save return',
    },
    actualAmountEntryDialog: {
      title: 'Record actual sales-order return amount',
      description:
        'Enter the actual return amount, notes, and evidence images for return {{returnNo}} so follow-up write-off or refund decisions have a clear basis.',
      summaryOrderNo: 'Source order number',
      summaryCustomer: 'Customer',
      summaryEstimatedAmount: 'Estimated return amount',
      summaryActualAmount: 'Currently recorded amount',
      amountLabel: 'Actual return amount',
      amountPlaceholder: 'Enter the confirmed actual return amount',
      amountNoteLabel: 'Amount note',
      amountNotePlaceholder:
        'Describe the basis, handling notes, or customer communication conclusion for this return amount...',
      evidenceTitle: 'Return amount evidence images',
      evidenceEmpty: 'No return amount evidence images yet',
      evidenceUploadAction: 'Upload return amount evidence',
      evidenceCameraAction: 'Take photo',
      evidenceNoteLabel: 'Image note',
      evidenceNotePlaceholder:
        'Example: refund receipt, customer confirmation screenshot, finance approval screenshot',
      evidenceUploadSuccess: 'Return amount evidence images uploaded',
      evidenceUploadFailed: 'Failed to upload return amount evidence images',
      submit: 'Save return amount',
    },
    actualAmountHistory: {
      title: 'Return amount records',
      description:
        'Each submission becomes an independent record and will later feed receivable adjustment cards and finance traceability.',
      empty: 'No return amount records for this return yet',
      note: 'Amount note',
      viewDetail: 'View record',
    },
    actualAmountRecordDetailDialog: {
      title: 'View return amount record',
      description:
        'Inspect the actual amount, note, and evidence captured in that submission for return {{returnNo}}.',
      returnNo: 'Return number',
      salesOrderNo: 'Source order number',
      estimatedAmountSnapshot: 'Estimated amount snapshot',
      note: 'Amount note',
      evidences: 'Amount evidence images',
    },
  },
  salesExchanges: {
  ...
  customers: {
    ...
    summary: {
      ...
      effectiveOrdersValue: '{{count}} effective orders',
      onlyCanceledOrders: 'Only Voided Orders',
      canceledOrdersValue: '{{count}} voided orders',
      statusCountItem: '{{status}} {{count}}',
      currentStatusValue: 'Current status: {{status}}',
      statusBreakdownValue: 'Status mix: {{summary}}',
      statusDraft: 'Draft',
  ...
  receivables: {
    ...
    returnAdjustments: {
      title: 'Sales return adjustment records',
      description:
        'Shows the sales-return amount records already synchronized into this receivable so finance can open each one and verify source and evidence.',
