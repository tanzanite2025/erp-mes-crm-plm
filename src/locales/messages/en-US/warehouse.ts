export const warehouse = {
  ...
  category: {
    title: 'Warehouse Area Topology Center',
    subtitle: 'Warehouse Structure',
    searchPlaceholder: 'Search warehouse structure...',
    add: 'Add Area',
    codeLabel: 'Code',
    permissionLevel: 'Permission Level',
    systemProtected: 'System Protected',
    userDefined: 'User Defined',
    empty: 'No system records',
    dialog: {
      createTitle: 'Create Area',
      editTitle: 'Edit Area',
      description: 'Configure storage unit',
    ...
    toast: {
      loadFailed: 'Failed to load warehouse categories',
      systemProtected: 'Built-in categories cannot be deleted',
      deleteConfirm: 'Delete this warehouse category?',
