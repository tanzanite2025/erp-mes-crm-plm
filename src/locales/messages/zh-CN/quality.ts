  ...
  standards: {
    ...
    dialog: {
      ...
      controlledProtocol: {
        ...
        titleView: '查看受控协议',
        description:
          '先为受控协议绑定产品与三级生产架构项，并给每个已选项补录目标重量。',
        fields: {
          product: '关联产品',
          level3: '三级架构项',
          selectedWeights: '已选项与重量',
          weight: '重量',
        },
        placeholders: {
          product: '请选择产品',
        ...
        empty: {
          stages: '当前暂无可选的三级架构数据，请先完成生产架构配置。',
          selections: '尚未添加任何三级架构项，请先从上方下拉中选择并添加。',
        },
        validation: {
          productRequired: '请先选择产品。',
          selectionRequired: '请至少添加一个三级架构项。',
          weightRequired: '请为每个已选三级架构项填写重量。',
        },
