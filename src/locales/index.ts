...
const zhCNMessagesWithBasicSettings = deepMerge(zhCNMessagesWithSales, basicSettingsZhCNOverrides)
...
const enUSMessagesWithBasicSettings = deepMerge(enUSMessagesWithSales, basicSettingsEnUSOverrides)
...
function getValueByPath(source: Record<string, unknown>, key: string): string | undefined {
...
export function translate(
  ...
  const template = getValueByPath(localeMessages, key) ?? getValueByPath(fallbackMessages, key) ?? key
