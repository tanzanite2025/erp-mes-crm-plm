...
const navGroupConfigs: SidebarGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      {
        titleKey: 'sidebar.items.experimentalEquipment',
        url: '/labs/experimental/equipment',
        icon: Cpu,
        permissionId: permissionIdForPath('/labs/experimental/equipment'),
      },
      {
        titleKey: 'sidebar.items.experimentalTests',
        url: '/labs/experimental/tests',
        icon: Gauge,
        permissionId: permissionIdForPath('/labs/experimental/tests'),
      },
      {
        titleKey: 'sidebar.items.experimentalReports',
        url: '/labs/experimental/reports',
        icon: FlaskConical,
        permissionId: permissionIdForPath('/labs/experimental/reports'),
      },
    ],
  },
  {
