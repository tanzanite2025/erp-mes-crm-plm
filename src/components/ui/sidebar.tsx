...
function SidebarInset({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'relative flex w-full flex-1 flex-col bg-background [--header-fixed-left:0px] md:peer-data-[state=expanded]:[--header-fixed-left:var(--sidebar-width)] md:peer-data-[collapsible=icon]:[--header-fixed-left:var(--sidebar-width-icon)] md:peer-data-[collapsible=offcanvas]:[--header-fixed-left:0px]',
