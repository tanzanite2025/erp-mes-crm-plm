...
export class BOMPerformanceMonitor {
   ...
   */
  constructor(thresholds: BOMPerformanceThresholds = DEFAULT_BOM_PERFORMANCE_THRESHOLDS) {
  ...
  endTiming(operation: string): number {
    ...
    if (startTime === undefined) {
      console.warn(`[BOMPerformanceMonitor] No start time found for operation: ${operation}`);
      return 0;
    }
