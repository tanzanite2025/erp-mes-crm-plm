...
export function AiEngineGatewayCard({
  ...
  return (
    <Card
      className={cn(
        'gap-0 overflow-hidden rounded-2xl border-2 border-dashed border-indigo-100 bg-indigo-50/5 py-0 shadow-none md:rounded-[28px]',
        className
      )}
    >
      <CardHeader className='flex flex-col items-start justify-between gap-3 border-b border-dashed border-indigo-100 !p-4 sm:flex-row sm:items-center'>
      ...
      <CardContent className='grid grid-cols-1 gap-3 !p-4 sm:grid-cols-2 xl:grid-cols-3'>
        <div className='flex flex-col gap-3 rounded-2xl border border-indigo-50 bg-white p-3 shadow-sm sm:col-span-2 sm:flex-row sm:items-center sm:justify-between xl:col-span-3'>
          ...
          <Button
            ...
            className='h-8 w-full rounded-full px-4 text-[10px] font-black tracking-widest uppercase sm:w-auto'
        ...
        <div className='space-y-1.5'>
          ...
          >
            <SelectTrigger className='h-10 rounded-xl border-2 border-indigo-100 bg-white'>
              <SelectValue
                placeholder={t(
