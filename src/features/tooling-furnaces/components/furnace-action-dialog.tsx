...
export function FurnaceActionDialog({
  ...
  return (
    <ActionDialogShell
      ...
      contentDecoration={<div className='pointer-events-none absolute inset-0 bg-linear-to-br from-primary/5 via-transparent' />}
      ...
      footer={
        <>
          <Button
            ...
            className='h-11 flex-1 rounded-full px-8 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 sm:flex-none'
          >
          ...
          <Button
            ...
            className='h-11 flex-1 rounded-full bg-blue-600 px-10 text-[10px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/20 transition-all active:scale-95 hover:bg-blue-700 sm:flex-none'
          >
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className='ml-1 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 italic'>
