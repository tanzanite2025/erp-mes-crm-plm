export const ENGINEERING_DB_SPECS_QUERY_KEY = ['engineering-db', 'specs'] as const
export const ENGINEERING_DB_NIPPLES_QUERY_KEY = ['engineering-db', 'nipples'] as const
...
export const ENGINEERING_DB_CUTTING_PLANS_QUERY_KEY = ['engineering-db', 'cutting-plans'] as const
