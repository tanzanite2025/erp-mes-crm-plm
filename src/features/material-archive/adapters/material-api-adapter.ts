...
export function toSaveMaterialApiDTO(material: Partial<Material>): SaveMaterialApiDTO {
  return {
    ...
    revisionNo: material.masterDataControl?.revisionNo || undefined,
    effectiveFrom: material.masterDataControl?.effectiveFrom ?? undefined,
    effectiveTo: material.masterDataControl?.effectiveTo ?? undefined,
    changeType: material.masterDataControl?.changeType || undefined,
    changeOrderNo: material.masterDataControl?.changeOrderNo || undefined,
    siteCode: material.masterDataControl?.siteCode || undefined,
    isDefaultSite: material.masterDataControl?.isDefaultSite ?? undefined,
