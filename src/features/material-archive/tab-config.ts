...
export function getMaterialStaticTabs(t: TranslateFn): TabItem[] {
  return [
    {
      key: 'all',
      label: t('materialArchive.layout.tabs.all'),
      href: '/materials/all',
    },
    {
      key: 'assembly',
      label: t('materialArchive.layout.tabs.assembly'),
      href: '/materials/assembly',
    },
  ]
}
...
export function getMaterialPermissionTabs(t: TranslateFn): TabItem[] {
  return [
    ...
    {
      key: 'category',
      label: t('materialArchive.layout.categoryDialogTitle'),
      href: '/materials/:category',
    },
  ]
}

export function getMaterialRouteTabs(
  locale: AppLocale,
  t: TranslateFn
): TabItem[] {
