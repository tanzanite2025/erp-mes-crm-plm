...
export type PackagingRuleDraft = Partial<SavePackagingRuleInput> &
  Pick<SavePackagingRuleInput, 'direction'>
...
export function buildPackagingRuleRelation(
  rule: Pick<
    PackagingRuleDraft,
    'conversionFactor' | 'packUnit' | 'baseUnit' | 'direction'
  > | null
) {
...
export function updatePackagingRuleDraftField<
...
export function togglePackagingRuleDirection(
  draft: PackagingRuleDraft | null
): PackagingRuleDraft {
...
export function toSavePackagingRuleInput(
  draft: PackagingRuleDraft | null
): SavePackagingRuleInput | null {
