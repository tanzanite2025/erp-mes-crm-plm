 ...
 */
export const BOMCell = memo(BOMCellComponent, arePropsEqual) as typeof BOMCellComponent;
 ...
 */
export interface EditableBOMCellProps<T extends BOMRowData = BOMRowData> 
  ...
  return (
    ...
    >
      <input
        ...
        className="w-full px-2 py-1 text-sm border border-muted rounded focus:outline-none focus:ring-2 focus:ring-amber-500"
      />
    </div>
  );
}
