...
function MetricCard({ icon, label, value, threshold, status, percentage }: MetricCardProps) {
  return (
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        {showDetails && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <MetricCard
              ...
              threshold={formatTime(metricsWithStatus.initialRenderTime.threshold)}
            ...
            <MetricCard
              ...
              threshold={formatNumber(metricsWithStatus.activeProxyCount.threshold)}
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t">
          <div>
            <div className="text-sm text-muted-foreground mb-1">脏行数</div>
            <div className="text-lg font-semibold">
              {formatNumber(latestMetrics.dirtyRowCount)}
            </div>
          </div>
          <div>
            <div className="text-sm text-muted-foreground mb-1">总行数</div>
            <div className="text-lg font-semibold">
        ...
        {averageMetrics && monitor.getMetricCount() > 1 && (
          <div className="pt-4 border-t">
            <div className="text-sm font-medium mb-3">平均性能指标</div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                <div className="text-muted-foreground mb-1">渲染</div>
                <div className="font-medium">
                  {formatTime(averageMetrics.initialRenderTime || 0)}
                </div>
              </div>
              <div>
                <div className="text-muted-foreground mb-1">编辑</div>
                <div className="font-medium">
...
export function BOMPerformanceDashboardCompact({
  ...
  return (
    <div className={cn('flex items-center gap-4 text-sm', className)}>
      <Badge variant={meetsThresholds ? 'default' : 'destructive'} className="gap-1">
