...
export function BOMDetailTable({ items, materials, sections: sectionOptions = [] }: BOMDetailTableProps) {
  if (!materials) {
          ...
          <div key={section} className='space-y-3'>
            ...
            <div className='flex items-center gap-2 px-1'>
              ...
              <h4 className='text-[10px] font-black uppercase tracking-[0.2em] text-slate-800 italic'>
                {t('engineering.productMgmt.bom.processNode')}: <span className='text-amber-600'>{resolveBOMSectionLabel(sectionOptions, section, section)}</span>
              </h4>
            </div>
