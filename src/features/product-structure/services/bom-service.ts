...
import {
  type BOMItemDraft,
  type SaveBOMInput,
} from '@/features/product-structure/mutation-types'
import {
  bomListSchema,
  bomSchema,
  type BOM,
...
function mapBOMWireToSchema(
  ...
  if (
    mapped.masterDataControl &&
    typeof mapped.masterDataControl === 'object'
  ) {
