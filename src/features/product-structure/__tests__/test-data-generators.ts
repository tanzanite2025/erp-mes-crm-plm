 ...
 * Units for BOM items
 */
const UNITS = ['个', '件', 'kg', 'g', 'm', 'cm', '套', '箱', '包', 'L']
...
export function generateBenchmarkDatasets(): {
  ...
  return [
    ...
    {
      name: '100 rows (clean)',
      rows: BOMDataPresets.small(0),
      dirtyPercentage: 0,
    },
    {
      name: '500 rows (clean)',
      rows: BOMDataPresets.medium(0),
      dirtyPercentage: 0,
    },
    {
      name: '1000 rows (clean)',
      rows: BOMDataPresets.large(0),
      dirtyPercentage: 0,
    },
    {
      name: '2000 rows (clean)',
      rows: BOMDataPresets.extraLarge(0),
      dirtyPercentage: 0,
    },

    // 1000 rows with different dirty percentages
    {
      name: '1000 rows (1% dirty)',
      rows: BOMDataPresets.large(1),
      dirtyPercentage: 1,
    },
    {
      name: '1000 rows (10% dirty)',
      rows: BOMDataPresets.large(10),
      dirtyPercentage: 10,
    },
    {
      name: '1000 rows (50% dirty)',
      rows: BOMDataPresets.large(50),
      dirtyPercentage: 50,
    },
    {
      name: '1000 rows (100% dirty)',
      rows: BOMDataPresets.large(100),
      dirtyPercentage: 100,
    },

    // Nested structure
    {
      name: '500 rows (nested)',
      rows: BOMDataPresets.nested(0),
      dirtyPercentage: 0,
    },
    {
      name: '500 rows (nested, 10% dirty)',
      rows: BOMDataPresets.nested(10),
      dirtyPercentage: 10,
    },
  ]
}
 ...
 */
export function getExpectedPerformanceMetrics(
  rowCount: number,
  dirtyPercentage: number
): {
