...
export const PERSONNEL_ARCHIVE_COLUMNS: PersonnelArchiveColumn[] = [
    ...
    { key: 'joinedDate', header: 'orgPersonnel.excel.columns.joinedDate', width: 14, importable: true },
    { key: 'workYears', header: 'orgPersonnel.excel.columns.workYears', width: 14 },
    { key: 'status', header: 'orgPersonnel.excel.columns.status', width: 12, importable: true, type: 'list', options: ['active', 'resigned', 'on-leave'] },
    { key: 'age', header: 'orgPersonnel.excel.columns.age', width: 10, importable: true },
    { key: 'idCard', header: 'orgPersonnel.excel.columns.idCard', width: 24, importable: true },
    { key: 'birthday', header: 'orgPersonnel.excel.columns.birthday', width: 14, importable: true },
    { key: 'address', header: 'orgPersonnel.excel.columns.address', width: 28, importable: true },
    { key: 'bankCard', header: 'orgPersonnel.excel.columns.bankCard', width: 24, importable: true },
    { key: 'bankName', header: 'orgPersonnel.excel.columns.bankName', width: 24, importable: true },
    { key: 'education', header: 'orgPersonnel.excel.columns.education', width: 12, importable: true, type: 'list', options: ['初中', '高中', '中专', '大专', '本科', '硕士', '博士'] },
]

export const PERSONNEL_TEMPLATE_COLUMNS = PERSONNEL_ARCHIVE_COLUMNS

export const PERSONNEL_TEMPLATE_SHEET_NAME = 'orgPersonnel.excel.templateSheetName'
...
export const PERSONNEL_IMPORT_COLUMNS = PERSONNEL_TEMPLATE_COLUMNS.filter(column => column.importable)
...
export const PERSONNEL_FORM_FIELDS: PersonnelFormFieldConfig[] = [
    ...
    },
    {
        ...
        input: 'date',
        placeholder: '',
        formValueFromEmployee: employee => formatPersonnelDate(employee.joinedDate),
        submitValueFromForm: value => (value ? new Date(value).toISOString() : null),
    },
    {
        key: 'status',
        input: 'select',
    ...
    },
    {
        ...
        formValueFromEmployee: employee =>
            employee.age !== undefined && employee.age !== null ? String(employee.age) : '',
