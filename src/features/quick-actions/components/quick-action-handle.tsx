  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'dark:bg-primary/10 dark:text-primary dark:border-primary/30 dark:shadow-primary/5 dark:hover:bg-primary dark:hover:text-primary-foreground',
        isDock
        ...
        isOpen && (isDock ? 'bg-primary text-primary-foreground dark:bg-primary dark:text-primary-foreground ring-2 ring-primary/20' : 'w-12 bg-primary')
      )}
    >
