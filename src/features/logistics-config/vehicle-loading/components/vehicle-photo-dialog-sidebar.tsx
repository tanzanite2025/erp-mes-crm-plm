      ...
      <div className='rounded-[22px] border border-dashed border-border/60 bg-muted/10 p-3'>
        ...
        <div className='mt-3 space-y-3'>
          <div className='rounded-[16px] border border-dashed border-primary/20 bg-primary/5 px-3 py-3'>
            <div className='text-[10px] font-black tracking-[0.18em] text-primary/70 uppercase'>
              {t('logisticsConfig.vehiclePhotos.currentView')}
            </div>
            <div className='mt-1.5 text-[12px] leading-5 font-semibold text-foreground'>
              {activeImage
                ? viewTypeLabel(activeImage.viewType)
                : t('logisticsConfig.vehiclePhotos.noImageSelected')}
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        ...
                        <div className='text-[12px] leading-5 font-semibold text-foreground'>
                          {annotation.title}
                        </div>
                      </div>
                      {annotation.tag ? (
