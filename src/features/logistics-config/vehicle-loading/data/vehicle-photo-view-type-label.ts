...
const VEHICLE_PHOTO_VIEW_TYPE_LABEL_KEYS: Record<VehiclePhotoViewType, TranslationKey> = {
...
export function getVehiclePhotoViewTypeLabel(t: TranslateFn, viewType: VehiclePhotoViewType): string {
