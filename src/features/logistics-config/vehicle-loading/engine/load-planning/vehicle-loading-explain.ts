...
export function isBetterPlan(candidate: VehicleLoadPlan, current: VehicleLoadPlan): boolean {
...
export function comparePlans(a: VehicleLoadPlan, b: VehicleLoadPlan): number {
  if (a.maxBoxesPerVehicle !== b.maxBoxesPerVehicle) return b.maxBoxesPerVehicle - a.maxBoxesPerVehicle
  if (a.weightUtilization !== b.weightUtilization) return b.weightUtilization - a.weightUtilization
  if (a.volumeUtilization !== b.volumeUtilization) return b.volumeUtilization - a.volumeUtilization
  return 0
}
