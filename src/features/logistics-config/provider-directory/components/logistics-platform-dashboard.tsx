...
import { useLogisticsPlatformAdmin } from '../hooks/use-logistics-platform-admin'
import type { LogisticsProvider } from '../types'
import { LogisticsPlatformState } from './logistics-platform-state'
import { LogisticsProviderCard } from './logistics-provider-card'
import { LogisticsProviderFormDialog } from './logistics-provider-form-dialog'

function getProviderSecretKey(provider: LogisticsProvider) {
  return String(provider.id ?? provider.code)
}

export function LogisticsPlatformDashboard() {
