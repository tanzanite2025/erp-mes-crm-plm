...
function SummaryCard({
  ...
  return (
    <Card className='rounded-[24px] border border-border/80 bg-background p-4 shadow-[0_10px_24px_rgba(15,23,42,0.06)] ring-1 ring-black/[0.02] dark:bg-card dark:shadow-[0_14px_30px_rgba(0,0,0,0.18)] dark:ring-white/[0.03]'>
