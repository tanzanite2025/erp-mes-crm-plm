...
export interface ScanPluginDefinition<TPayload = unknown, TContext = unknown> {
  ...
  resolveScan: (input: ScanResolveInput<TContext>) => Promise<ScanResolvedContext<TPayload>>
  submitAction?: (context: ScanResolvedContext<TPayload>) => Promise<ScanSubmitResult>
}
