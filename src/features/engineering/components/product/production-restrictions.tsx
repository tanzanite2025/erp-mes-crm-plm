...
export function ProductionRestrictions({ restrictions, setRestrictions }: ProductionRestrictionsProps) {
    ...
    return (
        <div className='p-1.5 bg-muted/5 border border-dashed border-muted rounded-[18px] space-y-1 transition-all hover:bg-muted/10 group'>
            ...
            <div className='flex flex-col gap-1.5'>
                <div className='flex flex-wrap gap-1 min-h-[28px] p-1 bg-muted/20 rounded-xl border border-dashed border-muted/50 shadow-inner group-hover:bg-muted/30 transition-all'>
                ...
                <div className='flex gap-1.5'>
                    <Input
                        ...
                        className='h-8 text-[11px] font-black uppercase tracking-widest flex-1 bg-muted/40 border-none rounded-xl focus-visible:ring-rose-400 italic'
                    />
                    <Button
                        type='button'
                        size='sm'
                        onClick={handleAddTag}
                        className='shrink-0 h-8 px-3 sm:px-4 bg-rose-600 hover:bg-rose-700 text-white rounded-full text-[11px] font-black uppercase tracking-widest shadow-md shadow-rose-600/10 active:scale-95 transition-all'
                    >
