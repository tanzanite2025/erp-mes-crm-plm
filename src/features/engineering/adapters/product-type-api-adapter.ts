...
export function toProductTypeApiDTO(type: Partial<ProductType>): ProductTypeApiDTO {
  return {
    id: type.id || '',
...
export function buildProductTypeDelta(current: ProductType, next: Partial<ProductType>): DeltaSet {
