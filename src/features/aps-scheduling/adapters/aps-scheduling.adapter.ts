import type {
  ...
  ProductionSegment,
} from '@/features/production-shared/data/production-line'
...
export function buildApsSchedulingSource(source: {
  ...
  const lanes =
    source.lanes ??
    jobs.reduce<ApsTimelineLaneDefinition[]>((acc, job) => {
  ...
  return {
    jobs,
    total: jobs.length,
    timelineSlots: source.timelineSlots ?? [
      '08:00',
      '10:00',
      '12:00',
      '14:00',
