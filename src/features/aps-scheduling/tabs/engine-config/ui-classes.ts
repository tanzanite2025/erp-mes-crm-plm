...
export const ENGINE_HERO_OVERLAY_CLASS =
  'pointer-events-none absolute inset-0 bg-linear-to-br from-cyan-500/10 via-transparent'

export const ENGINE_PANEL_CLASS =
  'rounded-[22px] border border-dashed border-muted/45 bg-background/80'
...
export const ENGINE_SECTION_HEADER_CLASS =
  'flex items-center justify-between gap-4'

export const ENGINE_SECTION_DECOR_CLASS = 'hidden items-center gap-2 md:flex'

export const ENGINE_KICKER_CLASS =
  'text-[10px] font-black uppercase tracking-[0.24em] text-muted-foreground/55'

export const ENGINE_SECTION_TITLE_CLASS =
  'mt-1 text-sm font-black tracking-tighter italic text-foreground'

export const ENGINE_CARD_TITLE_CLASS =
  'text-sm font-black tracking-tighter italic text-foreground'

export const ENGINE_HERO_DESC_CLASS =
  'text-[9px] font-black uppercase tracking-widest text-muted-foreground/60'

export const ENGINE_DESC_CLASS =
  'mt-1 text-[9px] font-black uppercase tracking-widest text-muted-foreground/60'
...
export const ENGINE_COMPACT_VALUE_CLASS =
  'text-[10px] font-black leading-5 tracking-tight text-foreground/90'
...
export const ENGINE_TABLE_ROW_CLASS =
  'odd:bg-background even:bg-muted/10 hover:bg-muted/15 transition-colors'

export function getEngineStatusBadgeToneClass(
...
export function getEngineStatusPanelToneClass(
  tone: GreedyEngineFactorStatusTone
): string {
  switch (tone) {
    case 'healthy':
...
export function getEngineStatusTextToneClass(
  tone: GreedyEngineFactorStatusTone
): string {
  switch (tone) {
    case 'healthy':
