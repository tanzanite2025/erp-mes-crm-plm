                ...
                <div className='flex flex-col lg:flex-row bg-background max-h-[80vh] overflow-y-auto lg:overflow-visible lg:h-[540px]'>
                    <div className='flex-1 p-5 md:p-6 space-y-6 overflow-y-auto'>
                            ...
                            <div className='space-y-6'>
                                <div className='space-y-1.5'>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) => setFormData((prev: any) => ({ ...prev, sourceCategory: val }))}
                                    >
                                    ...
                                    <div className='relative group'>
                                        ...
                                        <div className='absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1.5'>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => setFormData((prev: any) => ({ ...prev, quantity: categoryStock }))}
                                            >
                            ...
                            <div className='space-y-6'>
                                <div className='space-y-1.5'>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setFormData((prev: any) => ({ ...prev, shipmentDate: e.target.value }))}
                                    />
                                </div>
                                ...
                                <div className='space-y-1.5'>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) => setFormData((prev: any) => ({ ...prev, orderNo: val }))}
                                    >
                                        <SelectTrigger className='h-10 rounded-xl border-none bg-muted/30 font-bold focus:ring-blue-500 text-sm'>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 border-t border-dashed border-muted pt-6'>
                            <div className='space-y-1.5'>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setFormData((prev: any) => ({ ...prev, batchNo: e.target.value }))}
                                />
                            </div>
                            <div className='space-y-1.5'>
                                <Label className='text-[9px] font-black text-muted-foreground/40 flex items-center gap-2 uppercase tracking-widest'>
                        ...
                        <div className='pt-4 flex flex-wrap justify-end gap-2.5 shrink-0'>
                            ...
                            <Button
                                variant='outline'
                                className='rounded-full px-6 text-[9px] font-black uppercase tracking-widest gap-2 bg-amber-500/10 text-amber-600 border border-amber-500/20 hover:bg-amber-500/20 transition-all font-black'
                            ...
                            {warehouseCategories.map((cat) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => setFormData((prev: any) => ({ ...prev, sourceCategory: cat.value }))}
                                    >
