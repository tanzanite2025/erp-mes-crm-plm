...
export function WarehouseReports() {
            ...
            <div className='flex flex-col gap-8 animate-in fade-in duration-700'>
                ...
                <div className='flex flex-col items-center justify-center rounded-[32px] border border-dashed border-rose-200 bg-rose-50/60 px-6 py-14 text-center'>
                    ...
                    <Button
                        type='button'
                        variant='outline'
                        className='mt-5 h-11 rounded-full border-dashed px-5 text-[10px] font-black uppercase tracking-widest'
    ...
    const filteredInbound = readResource.status === 'ready' ? readResource.filteredInbound : []
    const filteredShipment = readResource.status === 'ready' ? readResource.filteredShipment : []
    const masterDataMap = readResource.status === 'ready' ? readResource.masterDataMap : {}
