        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          <div className='grid gap-4 md:grid-cols-4'>
            <div className='space-y-2 md:col-span-1'>
              <Label>{t('productionOutsourcing.partners.fields.code')}</Label>
              <Input
                value={values.code}
            ...
            <div className='space-y-2 md:col-span-2'>
              <Label>{t('productionOutsourcing.partners.fields.name')}</Label>
              <Input
                value={values.name}
            ...
            <div className='space-y-2 md:col-span-1'>
              <Label>{t('productionOutsourcing.partners.fields.status')}</Label>
              <select
                value={values.status}
                onChange={(event) =>
                  updateValue(
                ...
                className='h-11 w-full rounded-2xl border border-input bg-background px-3 text-xs font-bold shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 dark:bg-input/30'
              >
                <option value='ACTIVE'>
          ...
          <div className='grid gap-4 md:grid-cols-3'>
            ...
            <div className='space-y-2'>
              <Label>{t('productionOutsourcing.partners.fields.email')}</Label>
              <Input
                value={values.email}
          ...
          <div className='space-y-2'>
            <Label>{t('productionOutsourcing.partners.fields.notes')}</Label>
            <Textarea
              value={values.notes}
