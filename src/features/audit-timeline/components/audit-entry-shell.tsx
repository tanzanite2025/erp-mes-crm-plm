...
function normalizeAuditOperatorDisplay(operator: string, t: ReturnType<typeof useLanguage>['t']): string {
        ...
        <div className='flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between'>
          <div className='flex flex-wrap items-center gap-3'>
            ...
            <div className='flex items-center gap-1.5 rounded-full border border-dashed border-muted/40 bg-background px-2.5 py-1'>
              ...
              <span className='text-[10px] font-black tracking-tight text-slate-800'>{operatorDisplay}</span>
            </div>
          ...
          <div className='flex flex-wrap items-center gap-3 xl:justify-end'>
            ...
            <div className='flex items-center gap-1.5 rounded-full border border-dashed border-muted/40 bg-background px-2.5 py-1'>
              ...
              <span className='text-[10px] font-black tracking-tight text-slate-800'>{formatAuditTimestamp(createdAt)}</span>
            </div>
...
export function AuditEntryColumnCard({
  ...
  const body = (
    <div className={contentClassName ?? 'flex flex-col gap-2'}>
      {children}
    </div>
  )
