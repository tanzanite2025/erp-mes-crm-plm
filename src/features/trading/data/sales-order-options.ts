...
const SALES_ORDER_TYPE_DEFS: SalesOrderTypeDef[] = [
  {
    value: 'CUSTOMER',
    label: { 'zh-CN': '客户订单', 'en-US': 'Customer Order' },
  },
  {
    value: 'ESTIMATE',
    label: { 'zh-CN': '预估订单', 'en-US': 'Estimate Order' },
  },
  {
    value: 'OUTSOURCE',
    label: { 'zh-CN': '委外订单', 'en-US': 'Outsource Order' },
  },
  {
    value: 'REPLENISH',
    label: { 'zh-CN': '补货订单', 'en-US': 'Replenish Order' },
  },
...
const SALES_ORDER_CLASSIFICATION_DEFS: SalesOrderClassificationDef[] = [
  {
    value: 'GENERAL',
    label: { 'zh-CN': '一般贸易', 'en-US': 'General Trade' },
    ext: 'GS',
  },
  {
    value: 'TOLL',
    label: { 'zh-CN': '受托加工', 'en-US': 'Toll Processing' },
    ext: 'TL',
  },
  {
    value: 'RD',
    label: { 'zh-CN': '研发试制', 'en-US': 'R&D Trial' },
    ext: 'RD',
  },
  {
    value: 'PROJECT',
    label: { 'zh-CN': '项目专项', 'en-US': 'Project Order' },
    ext: 'PJ',
  },
  {
    value: 'SAMPLE',
    label: { 'zh-CN': '样品订单', 'en-US': 'Sample Order' },
    ext: 'SP',
  },
]
...
export function getSalesOrderTypeOptions(
  locale: AppLocale
): SalesOrderOption[] {
...
export function getSalesOrderTypeLabel(
...
export function getSalesOrderClassificationLabel(
  ...
  if (!value) return undefined
  const target = SALES_ORDER_CLASSIFICATION_DEFS.find(
    (item) => item.value === value
  )
  return target ? localize(locale, target.label) : undefined
}

export function getSalesOrderClassificationExt(
  value: string | undefined
): string {
  if (!value) return 'GS'
  const target = SALES_ORDER_CLASSIFICATION_DEFS.find(
