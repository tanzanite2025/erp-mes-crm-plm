...
import {
  ...
  type CreatePaymentRecordApiDTO,
  type CreatePaymentRecordResponseApiDTO,
...
export async function getPayableLedgerDetail(id: string): Promise<PayableDetailApiDTO> {
  ...
  return deserializePayableDetailApiDTO(payload)
}
...
export async function createPaymentRecord(
  ...
  return deserializeCreatePaymentRecordResponseApiDTO(response)
}
