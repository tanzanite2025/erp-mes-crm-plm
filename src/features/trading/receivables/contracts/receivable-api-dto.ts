...
export const receivableRecordApiDTOSchema = z
  .object({
    ...ledgerRecordBaseApiDTOShape,
...
export const receivableSummaryApiDTOSchema = z
  .object({
...
export type ReceivableRecordApiDTO = z.infer<
  typeof receivableRecordApiDTOSchema
>
export type ReceivableSummaryApiDTO = z.infer<
  typeof receivableSummaryApiDTOSchema
>
export type ReceivableListPageApiDTO = z.infer<
  typeof receivableListPageApiDTOSchema
>

export function deserializeReceivableListPageApiDTO(
  input: unknown
...
export const salesReturnActualAmountRecordApiDTOSchema = z
  .object({
    id: z.string(),
...
export const receivableDetailApiDTOSchema = createLedgerDetailApiDTOSchema(
  receivableRecordApiDTOSchema,
  {
    sourceType: z.string(),
    ...
    salesReturnActualAmountRecords: z.array(
      salesReturnActualAmountRecordApiDTOSchema
    ),
  }
)
...
export type SalesReturnActualAmountRecordApiDTO = z.infer<
  typeof salesReturnActualAmountRecordApiDTOSchema
>
export type ReceivableDetailApiDTO = z.infer<
  typeof receivableDetailApiDTOSchema
>

export function deserializeReceivableDetailApiDTO(
  input: unknown
): ReceivableDetailApiDTO {
  return receivableDetailApiDTOSchema.parse(input)
}

export const createReceiptRecordApiDTOSchema =
  createSettlementRecordApiDTOSchema
export type CreateReceiptRecordApiDTO = TradingCreateSettlementRecordApiDTO

export const createReceiptRecordResponseApiDTOSchema =
  createSettlementMutationResponseApiDTOSchema(
...
export type CreateReceiptRecordResponseApiDTO = z.infer<
  typeof createReceiptRecordResponseApiDTOSchema
>

export function deserializeCreateReceiptRecordResponseApiDTO(
  input: unknown
