      ...
      <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
        <div className='grid gap-3'>
          <Label htmlFor='name' className='pl-1 text-[10px] font-black uppercase tracking-widest text-muted-foreground/50'>
            {t('purchase.suppliers.fields.name')} <span className='text-destructive'>*</span>
          </Label>
        ...
        <div className='grid gap-3'>
          <Label htmlFor='code' className='pl-1 text-[10px] font-black uppercase tracking-widest text-muted-foreground/50'>
            {t('purchase.suppliers.fields.code')} {supplier && <span className='text-destructive'>*</span>}
          </Label>
          <Input
            id='code'
            placeholder={supplier ? t('purchase.suppliers.fields.codePlaceholder') : t('purchase.suppliers.fields.codeAutoPlaceholder')}
