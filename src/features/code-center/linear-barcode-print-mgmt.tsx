        ...
        <div className='flex flex-col gap-5'>
          <div className='flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between'>
            ...
            <div className='flex flex-wrap items-center gap-2'>
              <Badge className='border-none bg-primary/10 px-4 py-1.5 text-[10px] font-black tracking-[0.22em] text-primary/70 uppercase'>
                <Printer className='mr-2 size-3.5' />
                {statusBadgeLabel}
              </Badge>
              <Badge className='border-none bg-emerald-500/10 px-4 py-1.5 text-[10px] font-black tracking-[0.22em] text-emerald-700 uppercase'>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <Button
              className='rounded-full px-6 text-[10px] font-black uppercase shadow-lg shadow-primary/20'
              asChild
            >
            ...
            <Button
              variant='ghost'
              className='rounded-full px-6 text-[10px] font-black uppercase'
              asChild
            >
              <Link to='/code-center/shared-code-source/numbering-engine'>
                <Hash className='mr-2 size-4' />
                {t(
                  'codeCenter.linearBarcode.print.actions.gotoNumberingEngine'
                )}
              </Link>
            </Button>
          </div>
      ...
      <div className='grid gap-6 lg:grid-cols-3'>
        <Card className='rounded-[28px] border border-dashed border-muted/50 bg-muted/5 shadow-none'>
          <CardHeader>
            ...
            <CardDescription className='text-[11px] leading-6'>
              {t(
                'codeCenter.linearBarcode.print.sections.templates.description'
              )}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='space-y-4 rounded-[20px] border border-dashed border-muted/50 bg-background/60 p-5 text-[11px] leading-6 text-muted-foreground'>
              {ordersQuery.isLoading ? (
                <div className='flex items-center gap-2'>
                  ...
                  <span>
                    {t(
                      'codeCenter.linearBarcode.print.sections.templates.states.loadingOrders'
                    )}
                  </span>
                </div>
                ...
                <div>
                  {t(
                    'codeCenter.linearBarcode.print.sections.templates.states.emptyOrders'
                  )}
                </div>
              ) : (
                <div className='space-y-3'>
                  <div className='space-y-1'>
                    <div className='text-[10px] font-black tracking-[0.2em] text-muted-foreground/60 uppercase'>
                      {t(
                        'codeCenter.linearBarcode.print.sections.templates.selectLabel'
                      )}
                    </div>
                    <select
                    ...
                    >
                      <option value=''>
                        {t(
                          'codeCenter.linearBarcode.print.sections.templates.selectPlaceholder'
                        )}
                      </option>
                  ...
                  {!selectedOrderId ? (
                    <div className='rounded-xl border border-dashed bg-muted/10 px-3 py-3'>
                      {t(
                        'codeCenter.linearBarcode.print.sections.templates.states.awaitingSelection'
                      )}
                    </div>
                    ...
                    <div className='flex items-center gap-2 rounded-xl border border-dashed bg-muted/10 px-3 py-3'>
                      ...
                      <span>
                        {t(
                          'codeCenter.linearBarcode.print.sections.templates.states.loadingOrderDetail'
                        )}
                      </span>
                    </div>
                  ) : detailQuery.error ? (
                    <div className='rounded-xl border border-dashed border-rose-300/50 bg-rose-50/40 px-3 py-3 text-rose-700'>
                      {t(
                        'codeCenter.linearBarcode.print.sections.templates.states.orderDetailFailed'
                      )}
                    </div>
                  ) : selectedOrder ? (
                    <div className='grid gap-2 rounded-xl border border-dashed bg-muted/10 px-3 py-3'>
                      <div className='flex items-center justify-between gap-3'>
                        <span className='font-black text-muted-foreground/60'>
                          {t(
                            'codeCenter.linearBarcode.print.sections.templates.summary.orderNo'
                          )}
                        </span>
                      ...
                      <div className='flex items-center justify-between gap-3'>
                        <span className='font-black text-muted-foreground/60'>
                          {t(
                            'codeCenter.linearBarcode.print.sections.templates.summary.customer'
                          )}
                        </span>
                      ...
                      <div className='flex items-center justify-between gap-3'>
                        <span className='font-black text-muted-foreground/60'>
                          {t(
                            'codeCenter.linearBarcode.print.sections.templates.summary.status'
                          )}
                        </span>
                      ...
                      <div className='flex items-center justify-between gap-3'>
                        <span className='font-black text-muted-foreground/60'>
                          {t(
                            'codeCenter.linearBarcode.print.sections.templates.summary.lines'
                          )}
                        </span>
                        <span className='font-bold text-foreground'>
        ...
        <Card className='rounded-[28px] border border-dashed border-muted/50 bg-muted/5 shadow-none'>
          <CardHeader>
            ...
            <CardDescription className='text-[11px] leading-6'>
              {t(
                'codeCenter.linearBarcode.print.sections.parameters.description'
              )}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='space-y-4 rounded-[20px] border border-dashed border-muted/50 bg-background/60 p-5 text-[11px] leading-6 text-muted-foreground'>
              {protocolQuery.isLoading ? (
                <div className='flex items-center gap-2'>
                  ...
                  <span>
                    {t(
                      'codeCenter.linearBarcode.print.sections.parameters.states.loadingProtocol'
                    )}
                  </span>
                </div>
              ) : protocolQuery.error ? (
                <div className='rounded-xl border border-dashed border-rose-300/50 bg-rose-50/40 px-3 py-3 text-rose-700'>
                  {t(
                    'codeCenter.linearBarcode.print.sections.parameters.states.protocolLoadFailed'
                  )}
                </div>
              ) : (
                <>
                  <div className='grid gap-2 rounded-xl border border-dashed bg-muted/10 px-3 py-3'>
                    <div className='flex items-center justify-between gap-3'>
                      <span className='font-black text-muted-foreground/60'>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.summary.protocolVersion'
                        )}
                      </span>
                      <span className='font-mono font-bold text-foreground'>
                        {protocolQuery.data?.version || '--'}
                      </span>
                    </div>
                    <div className='flex items-center justify-between gap-3'>
                      <span className='font-black text-muted-foreground/60'>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.summary.sequenceRuleKey'
                        )}
                      </span>
                      <span className='font-mono font-bold text-foreground'>
                        {protocolQuery.data?.sequenceRuleKey || '--'}
                      </span>
                    </div>
                  </div>
                  <div className='rounded-xl border border-dashed bg-muted/10 px-3 py-3'>
                    <div className='mb-2 text-[10px] font-black tracking-[0.2em] text-muted-foreground/60 uppercase'>
                      {t(
                        'codeCenter.linearBarcode.print.sections.parameters.ruleTitle'
                      )}
                    </div>
                    <div className='grid gap-1'>
                      <div>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.rules.modelCode'
                        )}
                      </div>
                      <div>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.rules.holePrefix'
                        )}
                      </div>
                      <div>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.rules.appearanceCode'
                        )}
                      </div>
                      <div>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.rules.holeCount'
                        )}
                      </div>
                      <div>
                        {t(
                          'codeCenter.linearBarcode.print.sections.parameters.rules.quantity'
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <CardContent>
            <div className='space-y-4 rounded-[20px] border border-dashed border-muted/50 bg-background/60 p-5 text-[11px] leading-6 text-muted-foreground'>
              {!selectedOrderId ? (
                <div>
                  {t(
                    'codeCenter.linearBarcode.print.sections.preview.states.awaitingSelection'
                  )}
                </div>
              ) : detailQuery.isLoading ? (
                <div className='flex items-center gap-2'>
                  ...
                  <span>
                    {t(
                      'codeCenter.linearBarcode.print.sections.preview.states.loading'
                    )}
                  </span>
                </div>
                ...
                <div>
                  {t(
                    'codeCenter.linearBarcode.print.sections.preview.states.noLines'
                  )}
                </div>
              ) : (
                <>
                  <div className='flex flex-wrap items-center gap-2'>
                    <Badge className='border-none bg-emerald-500/10 text-emerald-700'>
                      ...
                      {t(
                        'codeCenter.linearBarcode.print.sections.preview.summary.ready',
                        { count: readyCount }
                      )}
                    </Badge>
                    <Badge className='border-none bg-amber-500/10 text-amber-700'>
                      ...
                      {t(
                        'codeCenter.linearBarcode.print.sections.preview.summary.blocked',
                        { count: blockedCount }
                      )}
                    </Badge>
                    <Button
                    ...
                    >
                      {isBatchPrinting
                        ? t(
                            'codeCenter.linearBarcode.print.sections.preview.actions.batchPrinting'
                          )
                        : t(
                            'codeCenter.linearBarcode.print.sections.preview.actions.batchPrintAll'
                          )}
                    </Button>
                  </div>
                  {batchPrintResult && (
