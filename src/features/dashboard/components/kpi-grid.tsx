...
export function KpiGrid() {
    ...
    return (
        <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
            {/* REALTIME_WIP */}
            <Card className='gap-2 rounded-xl border-dashed border-muted/50 bg-muted/5 py-2 md:rounded-[24px] md:py-2.5 shadow-none transition-all group overflow-hidden hover:bg-muted/10 relative'>
                <div className='absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent pointer-events-none' />
                <CardHeader className='flex flex-row items-center justify-between space-y-0 px-3 pt-0.5 pb-0 md:px-3.5 z-10'>
                    <CardTitle className='text-[10px] font-black uppercase tracking-widest italic text-muted-foreground/60'>
                ...
                <CardContent className='px-3 pb-0.5 md:px-3.5 z-10'>
                    {stats.availability.wip.connected ? (
                        <>
                            <div className='text-lg md:text-xl font-black tracking-tighter leading-none text-emerald-700 italic'>
                                {stats.wip.toLocaleString()} <span className='ml-1 text-[9px] font-black uppercase text-emerald-600/40 not-italic'>{t('dashboard.page.kpi.wip.unit')}</span>
                            </div>
            ...
            {/* SCRAP_FLOW */}
            <Card className='gap-2 rounded-xl border-dashed border-rose-500/20 bg-rose-500/2 py-2 md:rounded-[24px] md:py-2.5 shadow-none transition-all group overflow-hidden hover:bg-rose-500/5 relative'>
                <div className='absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent pointer-events-none' />
                <CardHeader className='flex flex-row items-center justify-between space-y-0 px-3 pt-0.5 pb-0 md:px-3.5 z-10'>
                    <CardTitle className='text-[10px] font-black uppercase tracking-widest italic text-rose-600/60'>
                ...
                <CardContent className='px-3 pb-0.5 md:px-3.5 z-10'>
                    {stats.availability.scrap.connected ? (
                        <>
                            <div className='text-lg md:text-xl font-black tracking-tighter leading-none text-rose-600 italic'>
                                {stats.scrap} <span className='ml-1 text-[9px] font-black uppercase text-rose-500/40 not-italic'>{t('dashboard.page.kpi.scrap.unit')}</span>
                            </div>
            ...
            {/* DELIVERY_GAP */}
            <Card className='gap-2 rounded-xl border-dashed border-amber-500/20 bg-amber-500/2 py-2 md:rounded-[24px] md:py-2.5 shadow-none transition-all group overflow-hidden hover:bg-amber-500/5 relative'>
                <div className='absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent pointer-events-none' />
                <CardHeader className='flex flex-row items-center justify-between space-y-0 px-3 pt-0.5 pb-0 md:px-3.5 z-10'>
                    <CardTitle className='text-[10px] font-black uppercase tracking-widest italic text-amber-600/60'>
                ...
                <CardContent className='px-3 pb-0.5 md:px-3.5 z-10'>
                    {stats.availability.gapOrders.connected ? (
                        <>
                            <div className='text-lg md:text-xl font-black tracking-tighter leading-none text-amber-600 italic'>
                                {stats.gapOrders} <span className='ml-1 text-[9px] font-black uppercase text-amber-600/40 not-italic'>{t('dashboard.page.kpi.gap.unit')}</span>
                            </div>
