...
export function KpiGrid() {
  ...
  return (
    <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
      {/* REALTIME_WIP */}
      <Card className='group relative gap-2 overflow-hidden rounded-xl border-dashed border-muted/50 bg-muted/5 py-2 shadow-none transition-all hover:bg-muted/10 md:rounded-[24px] md:py-2.5'>
      ...
      {/* SCRAP_FLOW */}
      <Card className='group relative gap-2 overflow-hidden rounded-xl border-dashed border-rose-500/20 bg-rose-500/2 py-2 shadow-none transition-all hover:bg-rose-500/5 md:rounded-[24px] md:py-2.5'>
        <div className='pointer-events-none absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent' />
        <CardHeader className='z-10 flex flex-row items-center justify-between space-y-0 px-3 pt-0.5 pb-0 md:px-3.5'>
      ...
      {/* DELIVERY_GAP */}
      <Card className='group relative gap-2 overflow-hidden rounded-xl border-dashed border-amber-500/20 bg-amber-500/2 py-2 shadow-none transition-all hover:bg-amber-500/5 md:rounded-[24px] md:py-2.5'>
        <div className='pointer-events-none absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent' />
        <CardHeader className='z-10 flex flex-row items-center justify-between space-y-0 px-3 pt-0.5 pb-0 md:px-3.5'>
