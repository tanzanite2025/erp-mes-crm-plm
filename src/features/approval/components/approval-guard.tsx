        ...
        <DialogContent className='sm:max-w-md rounded-[32px] border-none shadow-2xl'>
          ...
          <div className='space-y-4 py-6'>
            <div className='rounded-[24px] border border-dashed border-muted/50 bg-muted/5 p-4'>
              <p className='text-[11px] leading-relaxed font-black uppercase tracking-widest text-muted-foreground/60'>
            ...
            <div className='relative'>
              ...
              <Input
                className='h-14 rounded-2xl border-none bg-muted/50 pl-12 text-center text-2xl font-black font-mono tracking-[0.5em] transition-all focus-visible:ring-2 focus-visible:ring-primary/20'
                maxLength={6}
                placeholder='123456'
                value={pinCode}
                onChange={(event) =>
          ...
          <DialogFooter className='-mx-6 -mb-6 gap-2 rounded-b-[32px] bg-muted/30 p-4'>
            ...
            <Button
              ...
              className='rounded-full px-6 text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20'
