...
export const moldStatusSchema = z.enum([
  'IDLE',
  'IN_USE',
  'CHECKING',
  'MAINTENANCE',
...
export function createMoldSchema(t?: EquipmentToolingTranslate) {
  return z
    .object({
      ...
      currentCycles: z
        .number()
        .min(0, 'Current cycles must be greater than or equal to 0')
        .default(0),
      ...
      totalLifeCycles: z
        .number()
        .min(0, 'Total life cycles must be greater than or equal to 0')
        .default(0),
