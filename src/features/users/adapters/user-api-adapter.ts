...
export function toUserApiDTO(contract: User): UserApiDTO {
  return {
    ...
    permissionPresetId: contract.permissionPresetId,
...
export function toUserPermissionsResponseContract(
  ...
  return {
    ...
    presetPermissions: [...dto.presetPermissions],
...
export function toUserAccessSnapshotContract(
  ...
  return {
    ...
    employeeId: dto.employeeId,
    permissionPresetId: dto.permissionPresetId,
    presetPermissionIds: [...dto.presetPermissionIds],
    directPermissionIds: [...dto.directPermissionIds],
    status: dto.status,
    permissions: dto.permissions,
