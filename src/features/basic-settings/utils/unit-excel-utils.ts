...
export const UnitExcelTemplate = {
  async downloadTemplate(locale: AppLocale) {
    ...
    const sheet = workbook.addWorksheet(
      translate(locale, 'basicSettings.units.excel.sheetName'),
      {
    ...
    sheet.columns = [
      {
        header: translate(locale, 'basicSettings.units.excel.headers.code'),
        key: 'code',
        width: 25,
      },
      {
        header: translate(locale, 'basicSettings.units.excel.headers.name'),
        key: 'name',
        width: 25,
      },
      {
        header: translate(locale, 'basicSettings.units.excel.headers.category'),
        key: 'category',
        width: 15,
      },
      {
        header: translate(
          locale,
          'basicSettings.units.excel.headers.precision'
        ),
        key: 'precision',
        width: 15,
      },
      {
        header: translate(
          locale,
          'basicSettings.units.excel.headers.description'
        ),
        key: 'description',
        width: 40,
      },
    ...
    for (let i = 2; i <= 100; i++) {
      ...
      row.getCell('C').dataValidation = {
        ...
        errorTitle: translate(
          locale,
          'basicSettings.units.excel.validation.categoryErrorTitle'
        ),
        error: translate(
          locale,
          'basicSettings.units.excel.validation.categoryError'
        ),
      }
      ...
      row.getCell('D').dataValidation = {
        ...
        errorTitle: translate(
          locale,
          'basicSettings.units.excel.validation.precisionErrorTitle'
        ),
        error: translate(
          locale,
          'basicSettings.units.excel.validation.precisionError'
        ),
      }
    }
    ...
    sheet.addRow({
      ...
      precision: Number(
        translate(locale, 'basicSettings.units.excel.sample.precision1')
      ),
      description: translate(
        locale,
        'basicSettings.units.excel.sample.description1'
      ),
    })
    sheet.addRow({
      ...
      precision: Number(
        translate(locale, 'basicSettings.units.excel.sample.precision2')
      ),
      description: translate(
        locale,
        'basicSettings.units.excel.sample.description2'
      ),
    })
    ...
    anchor.href = url
    anchor.download = translate(locale, 'basicSettings.units.excel.fileName', {
      date,
    })
