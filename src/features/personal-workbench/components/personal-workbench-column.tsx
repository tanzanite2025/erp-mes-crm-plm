  ...
  return (
    ...
    >
      <header className='mb-3 flex items-center justify-between px-1'>
        <div>
          <h3 className='text-sm font-black tracking-tight text-foreground uppercase italic'>
      ...
      <div className='space-y-3'>
        {records.length > 0 ? (
          ...
          <div className='flex min-h-40 items-center justify-center rounded-[24px] border border-dashed border-muted/50 bg-background/40 text-[10px] font-black tracking-widest text-muted-foreground/40 uppercase'>
            暂无记录
          </div>
        )}
      </div>
