  ...
  return (
    <div
      className={cn(
        ...
        isRecording
          ? 'animate-pulse border-destructive/70 bg-destructive/5 shadow-[0_0_0_1px_rgba(220,38,38,0.18)]'
          : 'border-primary/20'
      )}
    >
      <div className='flex items-center gap-2'>
        ...
        {isRecording ? (
          <span className='text-[11px] font-black tracking-widest text-destructive uppercase'>
            正在记录现场
          </span>
        ) : null}
      </div>
