...
const personalWorkbenchCaptureRouteApi = getRouteApi('/_authenticated/personal-workbench/capture')

export function PersonalWorkbenchCaptureRouteComponent() {
  const { autoEdit, draftId, mode } = personalWorkbenchCaptureRouteApi.useSearch()
