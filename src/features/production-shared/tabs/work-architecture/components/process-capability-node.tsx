...
export function ProcessCapabilityNode({ processNode, resolvedProcesses }: ProcessCapabilityNodeProps) {
    ...
    return (
        <div className='space-y-3 relative pl-3 border-l-2 border-slate-100 group/process'>
            <div className='flex items-center justify-between pr-4'>
                ...
                <Button
                    variant='ghost'
                    size='icon'
                    className='size-6 opacity-0 group-hover/process:opacity-100 hover:bg-orange-100 rounded-lg text-muted-foreground hover:text-orange-600 transition-opacity'
