...
const ROUTE_PERMISSION_LABEL_KEYS: Record<string, TranslationKey> = {
  ...
  '/piecework/templates': 'piecework.layout.tabs.templates',
  ...
  '/attendance-management': 'sidebar.items.attendanceManagement',
  '/attendance-management/leave': 'orgPersonnel.tabs.leave',
  '/attendance-management/hall-of-fame': 'orgPersonnel.tabs.stats',
  '/attendance-management/devices': 'orgPersonnel.tabs.attendanceDevices',
  ...
  '/sidebar-command/assignment': 'sidebar.items.sidebarCommandConfig',
  '/sidebar-command/library': 'sidebar.items.sidebarCommandConfig',
