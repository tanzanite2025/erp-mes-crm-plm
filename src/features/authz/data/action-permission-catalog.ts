...
const systemActions: LegacyActionPermissionEntry[] = [
  ...
  },
  {
    ...
    routeBindings: [
      ...
      'POST /system/routing/event-sources',
      'POST /system/routing/event-sources/:id/status-rename-transaction',
      'PUT /system/routing/event-sources/:id',
      'DELETE /system/routing/event-sources/:id',
