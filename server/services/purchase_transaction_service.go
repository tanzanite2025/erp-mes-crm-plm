...
func executePurchaseOrderTransactionTx(tx *gorm.DB, input ExecutePurchaseOrderTransactionInput) (*models.PurchaseOrder, error) {
	...
	if intent != PurchaseTransactionIntentExpectedDateChange && intent != PurchaseTransactionIntentOrderLineAdd && intent != PurchaseTransactionIntentOrderLineContentChange {
