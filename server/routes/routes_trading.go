...
func registerTradingRoutes(authorized *gin.RouterGroup) {
	...
	warehouseShipmentRecord := middleware.RequireAnyPermission(authz.ActionWarehouseShipmentRecord)
	...
	salesReturnGroup.POST("/:id/line-barcodes", salesOrderManage, handlers.BindSalesReturnLineBarcodesHandler)
	salesReturnGroup.POST("/:id/inbound", warehouseInboundRecord, handlers.ConfirmSalesReturnInboundHandler)
	...
	salesExchangeGroup.PATCH("/:id/old-item-logistics", salesOrderManage, handlers.PatchSalesExchangeOldItemLogisticsHandler)
	salesExchangeGroup.POST("/:id/old-item-inbound", warehouseInboundRecord, handlers.ConfirmSalesExchangeOldItemInboundHandler)
	salesExchangeGroup.POST("/:id/replacement-shipment", warehouseShipmentRecord, handlers.ConfirmSalesExchangeReplacementShipmentHandler)
	salesExchangeGroup.POST("/:id/replacement-shipment/:shipmentId/void", warehouseShipmentRecord, handlers.VoidSalesExchangeReplacementShipmentHandler)
